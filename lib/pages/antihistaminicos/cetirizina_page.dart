...
class CetirizinaPage extends StatefulWidget {
  @override
  _CetirizinaPageState createState() => _CetirizinaPageState();
}

class _CetirizinaPageState extends State<CetirizinaPage> {
  ...
  String calcularOrientacao() {
    switch (grupoSelecionado) {
      case 'Crianças de 2 a 5 anos':
        return '''- Cetirizina 1mg/ml - 2.5 mL, em intervalos de 12/12 horas, por via oral.
- Cetirizina 10mg - Esta apresentação não é uma boa indicação pelo sub-dose ou super-dose.''';
      case 'Crianças de 6 a 9 anos':
        return '''- Cetirizina 1mg/ml - 5 mL, em intervalos de 12/12 horas, por via oral.
- Cetirizina 10mg - Esta apresentação não é uma boa indicação pelo sub-dose ou super-dose.''';
      case 'Crianças acima de 10 anos':
        return '''- Cetirizina 1mg/ml - 10 mL, em intervalos de 24/24 horas, por via oral.
- Cetirizina 10mg - 1 comprimido, em intervalos de 24/24 horas, por via oral.''';
      default:
