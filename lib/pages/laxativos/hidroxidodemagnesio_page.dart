...
class _HidroxidoPageState extends State<HidroxidoPage> {
  ...
  final Map<String, Function(double)> calculosPorFaixa = {
    'Crianças de 2 a 6 anos': (double peso) => peso, // Exemplo de cálculo
    'Crianças de 6 a 12 anos': (double peso) => peso, // Exemplo de cálculo
  ...
  String calcularOrientacao() {
    ...
    if (faixaEtaria == 'Crianças de 2 a 6 anos') {
      return 'Hidróxido de Magnésio 90mg/mL - 5 a 15 mL, uma vez ao dia, por via oral. A posologia deve ser ajustada para que se obtenham duas ou três evacuações por dia.'; // dose máxima para a faixa de 1 a 3 anos
    } else if (faixaEtaria == 'Crianças de 6 a 12 anos') {
      return 'Hidróxido de Magnésio 90mg/mL - 15 a 30 mL, uma vez ao dia, por via oral. A posologia deve ser ajustada para que se obtenham duas ou três evacuações por dia.'; // dose fixa para a faixa de 4 a 6 anos
    }  else if (faixaEtaria == 'Crianças acima de 12 anos') {
      return 'Hidróxido de Magnésio 90mg/mL - 30 a 60 mL, uma vez ao dia, por via oral. A posologia deve ser ajustada para que se obtenham duas ou três evacuações por dia.'; // dose fixa para a faixa de 4 a 6 anos
    }
    return "Hidróxido de Magnésio 90mg/mL - 5 a 15 mL, uma vez ao dia, por via oral. A posologia deve ser ajustada para que se obtenham duas ou três evacuações por dia.";
  }
