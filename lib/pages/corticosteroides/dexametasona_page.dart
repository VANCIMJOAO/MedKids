...
class _AcebrofilinaPageState extends State<AcebrofilinaPage> {
  ...
  final Map<String, Function(double)> calculosPorFaixa = {
    'Anti-Inflamatório': (double peso) => (peso * 0.02) * 5, // Exemplo de cálculo
    'Laringotrqueobronquite Aguda': (double peso) => (peso / 5) + 1, // Exemplo de cálculo
    'Edema Cerebral': (double peso) => peso / 5,
    'Meningite': (double peso) => peso /5,
  ...
  String calcularOrientacao() {
    ...
    if (faixaEtaria == 'Anti-Inflamatório' && dose > 10) {
